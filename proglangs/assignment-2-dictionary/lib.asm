...
read_error: db "There is no such key or an error occured while reading", 10, 0


section .text
 global exit, string_length, print_string, print_char, print_newline, print_uint, print_int, string_equals, string_copy, read_char, read_word, print_read_error, print_no_key_found_error, print_error
...
print_char:
    push rdi ; pushing symbol code on stack
